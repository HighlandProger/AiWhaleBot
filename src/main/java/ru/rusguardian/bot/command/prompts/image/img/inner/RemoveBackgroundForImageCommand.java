...
public class RemoveBackgroundForImageCommand extends Command implements SendPromptImageService {
    ...
    protected void mainExecute(Update update) throws TelegramApiException {
        ...
        processImagePrompt.processRemoveBackground(chat, initImageUrl)
