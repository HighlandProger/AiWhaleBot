...
public class SuperQualityForImageCommand extends Command implements SendPromptImageService {

    private final ProcessImagePrompt processImagePrompt;

    @Override
    public CommandName getType() {
        return CommandName.SUPER_QUALITY_FOR_IMAGE;
    }
    ...
    protected void mainExecute(Update update) throws TelegramApiException {
        ...
        processImagePrompt.processSuperResolution(chat, initImageUrl)
