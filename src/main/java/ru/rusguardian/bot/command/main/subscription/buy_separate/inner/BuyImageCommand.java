...
public class BuyImageCommand extends Command {
    ...
    protected void mainExecute(Update update) throws TelegramApiException {
        ...
        editMessage(update, getTextByViewDataAndChatLanguage(BUY_IMAGE, language),
                choosePurchaseCountKeyboardService.getKeyboard(AIModel.BalanceType.IMAGE, language));
    }
}
