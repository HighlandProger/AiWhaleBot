...
public enum AssistantRole {
    ...
    USUAL("Обычный \uD83D\uDD01", null, "Эта роль представляет собой стандартное поведение бота, отвечающего на ваши запросы без каких-либо специальных модификаций или ограничений."),
    GOPNIK("Гопник \uD83E\uDDE2", ""),
